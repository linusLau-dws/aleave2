...
- [DW-iLeave Documentation](#dw-ileave-documentation)
- [Highlights](#highlights)
  ...
  - [Download Payroll & Taxation Forms](#download-payroll--taxation-forms)
    - [iOS](#ios)
    - [Android](#android)
  - [Forced password change on first login](#forced-password-change-on-first-login)
  - [Chatroom](#chatroom)
    - [iOS](#ios-1)
    - [Android](#android-1)
- [Security](#security)
...
- [Back end](#back-end)
  - [Trigger](#trigger)
  - [Meaning of parameters in MobileSvc.asmx](#meaning-of-parameters-in-mobilesvcasmx)
  - [MySQL Version](#mysql-version)
    - [Set up SQL mode](#set-up-sql-mode)
    - [Set up ODBC drivers](#set-up-odbc-drivers)
    - [Set up SQL Server](#set-up-sql-server)
    - [Set up ASP.NET (C#)](#set-up-aspnet-c)
    - [Trigger](#trigger-1)
